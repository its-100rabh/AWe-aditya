...
const FloatingTextInputContact = React.forwardRef<TextInput, FloatingTextInputProps>(
  (
    {
      label,
      containerStyle,
...
FloatingTextInputContact.displayName = 'FloatingTextInputContact';

export default FloatingTextInputContact;
