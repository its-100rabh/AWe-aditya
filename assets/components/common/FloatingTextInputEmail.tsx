...
const FloatingTextInputEmail = React.forwardRef<TextInput, FloatingTextInputProps>(
  (
    {
      label,
      containerStyle,
...
FloatingTextInputEmail.displayName = 'FloatingTextInputEmail';

export default FloatingTextInputEmail;
